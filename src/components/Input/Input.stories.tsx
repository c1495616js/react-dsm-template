...
export const Basic = () => (
  ...
  >
    ...
    <Input placeholder="please enter text" value="Read Only" readOnly />
  </div>
);
...
export const Sizes = () => (
  ...
  >
    ...
    <Input placeholder="please enter text" size="small" error />
    <Input placeholder="please enter text" size="medium" error />
    <Input placeholder="please enter text" size="large" error />
  </div>
);
...
export const PrefixSuffix = () => (
  ...
  >
    ...
    <Input
      ...
      size="small"
    />
    <Input placeholder="search" prefix={<Icon icon={SearchIcon} />} />
    <Input
      placeholder="search"
      prefix={<Icon icon={SearchIcon} />}
      size="large"
