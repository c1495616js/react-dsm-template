...
export type NotificationConfigProps = Pick<NotifierConfig, 'duration'>;
...
const Notification: Notification = ((
  ...
  return (
    <Fade in={open} addEndListener={() => {}}>
      <div className={`host ${severity ? NotificationSeverity[severity] : ''}`}>
        {targetIcon ? (
          <div className="iconContainer">
            <Icon icon={targetIcon} className="severityIcon" />
          </div>
        ) : null}
        <div className="body">
        ...
        <Icon icon={TimesIcon} className="closeIcon" onClick={onClose} />
      </div>
    </Fade>
  );
}) as Notification;
